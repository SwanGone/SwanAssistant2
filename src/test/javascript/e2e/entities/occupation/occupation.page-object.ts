...
export class OccupationComponentsPage {
  ...
  deleteButtons = element.all(by.css('jhi-occupation div table .btn-danger'));
  title = element.all(by.css('jhi-occupation div h2#page-heading span')).first();
...
export class OccupationUpdatePage {
  pageTitle = element(by.id('jhi-occupation-heading'));
...
export class OccupationDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-occupation-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-occupation'));
